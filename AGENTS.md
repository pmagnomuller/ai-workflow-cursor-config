...
- **Jira MCP**: Fetch tickets, update status, create issues
- **GitHub MCP**: Create PRs, review code, manage branches
- **Notion MCP**: Read and update documentation pages
...
2. Use GitHub MCP to fetch repository information
...
4. Use GitHub MCP to create the PR with:
...
- **Cannot access** systems not configured via MCP
...
- Check MCP server connections in Cursor status bar
...
**Agent not using MCPs?**
- Verify MCP servers are connected
- Check `.cursor/mcp.json` configuration
- Test MCP connections individually
